 ...
 */
@Service
public class SimilarProductsCateService extends RecommendService {

    @Autowired
    private ProductRecommendTemplate tmp;

    public SimilarProductsCateService() {
        serviceName = ServiceType.SIMILAR_INGREDIENT_PRODUCTS_WITH_CATE.getDesc();
    }
